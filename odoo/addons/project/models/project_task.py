...
class Task(models.Model):
    ...
    def action_timer_stop(self):
        """Stop the work timer and optionally create timesheet entry."""
        self.ensure_one()
        if not self.timer_start:
            return True
        ...
        # Note: Timesheet integration handled by loomworks_fsm module
        # when installed - this just resets the timer
        self.write({
            'timer_start': False,
            'timer_pause': False,
        })
