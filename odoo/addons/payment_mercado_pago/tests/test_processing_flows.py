...
from loomworks.addons.payment_mercado_pago.controllers.main import MercadoPagoController
...
class TestProcessingFlows(MercadoPagoCommon, PaymentHttpCommon):
    ...
    @mute_logger('loomworks.addons.payment_mercado_pago.controllers.main')
