...
from loomworks.addons.base.tests.test_mimetypes import PNG
...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('loomworks.models', 'loomworks.addons.base.models.ir_rule')
...
class TestAccessHttp(common.SlidesCase, HttpCase):
    @mute_logger('loomworks.models', 'loomworks.addons.base.models.ir_rule', 'loomworks.http')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('loomworks.models.unlink', 'loomworks.addons.base.models.ir_rule', 'loomworks.addons.base.models.ir_model')
...
class TestReview(common.SlidesCase, HttpCase):
    ...
    def test_channel_multiple_reviews(self):
        ...
        self.assertIn("loomworks.exceptions.ValidationError", res2.text)
