...
from loomworks.addons.payment_flutterwave.controllers.main import FlutterwaveController
...
class TestProcessingFlows(FlutterwaveCommon, PaymentHttpCommon):
    ...
    @mute_logger('loomworks.addons.payment_flutterwave.controllers.main')
    ...
    def test_webhook_notification_triggers_processing(self):
        ...
        with patch(
            'loomworks.addons.payment_flutterwave.controllers.main.FlutterwaveController.'
