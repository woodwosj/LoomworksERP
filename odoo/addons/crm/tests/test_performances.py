...
from loomworks.addons.crm.tests.test_crm_lead_assignment import TestLeadAssignCommon
...
class TestLeadAssignPerf(TestLeadAssignCommon):
    ...
    @mute_logger('loomworks.models.unlink', 'loomworks.addons.crm.models.crm_team', 'loomworks.addons.crm.models.crm_team_member')
