...
from loomworks.addons.website_google_map.controllers.main import GoogleMap
from loomworks.addons.website_partner.controllers.main import WebsitePartnerPage
