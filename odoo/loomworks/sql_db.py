...
def connection_info_for(db_or_uri, readonly=False):
    ...
    if 'ODOO_PGAPPNAME' in os.environ:
        ...
        app_name = "loomworks-%d" % os.getpid()
...
def db_connect(to, allow_uri=False, readonly=False):
    ...
    maxconn = loomworks.evented and tools.config['db_maxconn_gevent'] or tools.config['db_maxconn']
...
def close_db(db_name):
    """ You might want to call loomworks.modules.registry.Registry.delete(db_name) along this function."""
    if _Pool:
