...
# ----------------------------------------------------------
# loomworks must be a namespace package for loomworks.addons to become one too
...
def registry(database_name=None):
    ...
    warnings.warn("Use directly loomworks.modules.registry.Registry", DeprecationWarning, 2)
...
from . import fields
from . import api
from loomworks.tools.translate import _, _lt
