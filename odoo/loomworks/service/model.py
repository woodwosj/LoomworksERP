...
from loomworks.tools import DotDict, lazy
from loomworks.tools.translate import translate_sql_constraint
...
def execute_cr(cr, uid, obj, method, *args, **kw):
    ...
    result = retrying(partial(loomworks.api.call_kw, recs, method, args, kw), env)
...
def retrying(func, env):
    ...
    :param loomworks.api.Environment env: The environment where the registry
