...
RPC_VERSION_1 = {
        'server_version': loomworks.release.version,
        'server_version_info': loomworks.release.version_info,
        'server_serie': loomworks.release.serie,
        'protocol_version': 1,
}
...
def exp_about(extended=False):
    ...
    if extended:
        return info, loomworks.release.version
    return info

def exp_set_loglevel(loglevel, logger=None):
    # TODO Previously, the level was set on the now deprecated
    # `loomworks.netsvc.Logger` class.
    return True
