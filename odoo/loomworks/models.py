...
if typing.TYPE_CHECKING:
    ...
    from loomworks.api import Self, ValuesType, IdType
    ...
    def __new__(meta, name, bases, attrs):
        ...
        if attrs.get('_register', True):
            ...
            if '_module' not in attrs:
                ...
                assert module.startswith('loomworks.addons.'), \
                    f"Invalid import of {module}.{name}, it should start with 'loomworks.addons'."
...
class BaseModel(metaclass=MetaModel):
    ...
    *   :class:`AbstractModel` for abstract super classes meant to be shared by
    ...
    the :attr:`~loomworks.models.BaseModel._register` attribute may be set to False.
    """
    ...
    If set to ``False``, override :meth:`~loomworks.models.BaseModel.init`
    ...
    .. tip:: To create a model without any table, inherit
            from :class:`~loomworks.models.AbstractModel`.
    """
    ...
    .. warning::
      ...
      :attr:`~loomworks.models.Model._inherits`-ed models, the inherited field will
    ...
    def load(self, fields, data):
        ...
        for field_path in fields:
            ...
            for field_name in field_path:
                ...
                if isinstance(model_fields.get(field_name), loomworks.fields.One2many):
    ...
    def _compute_display_name(self):
        ...
        it can be made field-dependent using :attr:`~loomworks.api.depends` and
        context-dependent using :attr:`~loomworks.api.depends_context`.
        """
        if self._rec_name:
    ...
    def _read_group_fill_temporal(self, data, groupby, annoted_aggregates,
        ...
        if fill_from:
            fill_from = loomworks.fields.Datetime.to_datetime(fill_from) if isinstance(fill_from, datetime.datetime) else loomworks.fields.Date.to_date(fill_from)
        ...
        if fill_to:
            fill_to = loomworks.fields.Datetime.to_datetime(fill_to) if isinstance(fill_to, datetime.datetime) else loomworks.fields.Date.to_date(fill_to)
    ...
    def _field_to_sql(self, alias: str, fname: str, query: (Query | None) = None, flush: bool = True) -> SQL:
        ...
        result to make method :meth:`~loomworks.api.Environment.execute_query` flush
    ...
    def _check_company(self, fnames=None):
        ...
        :raises UserError: if the `company_id` of the value of any field is not
            ...
            :class:`~loomworks.addons.base.models.res_company`).

        For :class:`~loomworks.addons.base.models.res_users` relational fields,
    ...
    def write(self, vals: ValuesType) -> typing.Literal[True]:
        ...
        * For numeric fields (:class:`~loomworks.fields.Integer`,
          :class:`~loomworks.fields.Float`) the value should be of the
          corresponding type
        * For :class:`~loomworks.fields.Boolean`, the value should be a
          :class:`python:bool`
        * For :class:`~loomworks.fields.Selection`, the value should match the
          selection values (generally :class:`python:str`, sometimes
          :class:`python:int`)
        * For :class:`~loomworks.fields.Many2one`, the value should be the
          database identifier of the record to set
        * The expected value of a :class:`~loomworks.fields.One2many` or
          :class:`~loomworks.fields.Many2many` relational field is a list of
          :class:`~loomworks.fields.Command` that manipulate the relation the
          implement. There are a total of 7 commands:
          :meth:`~loomworks.fields.Command.create`,
          :meth:`~loomworks.fields.Command.update`,
          :meth:`~loomworks.fields.Command.delete`,
          :meth:`~loomworks.fields.Command.unlink`,
          :meth:`~loomworks.fields.Command.link`,
          :meth:`~loomworks.fields.Command.clear`, and
          :meth:`~loomworks.fields.Command.set`.
        * For :class:`~loomworks.fields.Date` and `~loomworks.fields.Datetime`,
          ...
          .. warning::
            ...
            :const:`loomworks.tools.misc.DEFAULT_SERVER_DATE_FORMAT` and
            :const:`loomworks.tools.misc.DEFAULT_SERVER_DATETIME_FORMAT`
    ...
    def ensure_one(self) -> Self:
        ...
        :raise loomworks.exceptions.ValueError: ``len(self) != 1``
        """
        try:
    ...
    def with_env(self, env: api.Environment) -> Self:
        ...
        :param env:
        :type env: :class:`~loomworks.api.Environment`
    ...
    def with_company(self, company) -> Self:
        ...
        :type company: :class:`~loomworks.addons.base.models.res_company` or int
