...
import loomworks
from loomworks import api, http
from loomworks.addons import __path__ as ADDONS_PATH
from loomworks.addons.base.models.assetsbundle import AssetsBundle, XMLAssetError, ANY_UNIQUE
from loomworks.addons.base.models.ir_asset import AssetPaths
from loomworks.addons.base.models.ir_attachment import IrAttachment
...
from loomworks.tools import mute_logger, func
...
class AddonManifestPatched(TransactionCase):
    def setUp(self):
        ...
        self.patch(loomworks.modules.module, '_get_manifest_cached', Mock(side_effect=lambda module: self.manifests.get(module, {})))
...
class TestAssetsManifest(AddonManifestPatched):
    ...
    @mute_logger('loomworks.addons.base.models.ir_asset')
    def test_31(self):
...
class TestErrorManagement(HttpCase):
    ...
    def test_assets_bundle_css_error_backend(self):
        ...
        with mute_logger('loomworks.addons.base.models.assetsbundle'):
            self.start_tour('/loomworks', 'css_error_tour', login='admin')
