...
from loomworks.tools import transpile_javascript
...
class TestJsTranspiler(TransactionCase):
    ...
    def test_01_alias(self):
        input_content = """/** @loomworks-module alias=test_assetsbundle.Alias **/"""
...
'use strict';
let __exports = {};
/** @loomworks-module alias=test_assetsbundle.Alias **/
return __exports;
});
...
"""
    ...
    def test_02_default(self):
        input_content = """/** @loomworks-module alias=test_assetsbundle.Alias default=False **/"""
        result = transpile_javascript("/test_assetsbundle/static/src/alias.js", input_content)

        expected_result = """odoo.define('@test_assetsbundle/alias', [], function (require) {
'use strict';
let __exports = {};
/** @loomworks-module alias=test_assetsbundle.Alias default=False **/
return __exports;
});
...
"""
        ...
        input_content = """/** @loomworks-module alias=test_assetsbundle.Alias default=0 **/"""
        result = transpile_javascript("/test_assetsbundle/static/src/alias.js", input_content)

        expected_result = """odoo.define('@test_assetsbundle/alias', [], function (require) {
'use strict';
let __exports = {};
/** @loomworks-module alias=test_assetsbundle.Alias default=0 **/
return __exports;
});
