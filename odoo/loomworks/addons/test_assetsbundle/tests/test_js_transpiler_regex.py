...
from loomworks.tools import URL_RE, ODOO_MODULE_RE
...
class TestJsTranspiler(TransactionCase):
    ...
    def test_correct_ODOO_MODULE_RE(self):
        cases = [
            ...
            '/*@loomworks-module',
            '/**@loomworks-module',
            '// @loomworks-module alias=web.test',
            '/* @loomworks-module  alias=web.test',
            '/** @loomworks-module  alias=web.test',
            '/** @loomworks-module  alias=web.test**/',
            '/* @loomworks-module  alias=web.test ',
            '/* @loomworks-module alias=web.test default=false',
            '/* @loomworks-module alias=web.test default=false ',
            '/* @loomworks-module alias=web.test default=false**/',
        ]
    ...
    def test_incorrect_ODOO_MODULE_RE(self):
        ...
        cases = [
            '// @loomworks-modulealias=web.test',
            '/* @loomworks-module alias=web.testdefault=false',
        ]
