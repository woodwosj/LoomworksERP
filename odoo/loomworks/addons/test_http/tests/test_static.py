...
import loomworks
from loomworks.tests import new_test_user, tagged, RecordCapturer
from loomworks.tools import config, file_open, image_process
from loomworks.tools.misc import submap
...
class TestHttpStaticLogo(TestHttpStaticCommon):
    ...
    def setUpClass(cls):
        ...
        super_user = cls.env['res.users'].browse([loomworks.SUPERUSER_ID])
