...
from loomworks.tests.common import new_test_user, Like
from loomworks.tools import mute_logger
from loomworks.addons.test_http.utils import HtmlTokenizer
...
class TestHttpModels(TestHttpBase):
    ...
    def test_models5_stargate_setname_readonly(self):
        ...
        with self.assertLogs('loomworks.http', 'WARNING') as capture_http,\
             self.assertLogs('loomworks.sql_db', 'WARNING') as capture_sql_db:
