...
from loomworks import api, fields, models, tools, Command
from loomworks.exceptions import AccessError, UserError, ValidationError
from loomworks.osv import expression
from loomworks.tools import format_list, lazy_property, sql, unique, OrderedSet, SQL
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in loomworks.modules.loading.
