...
from loomworks.exceptions import MissingError, UserError
from loomworks.http import Stream, request
from loomworks.tools import file_open, replace_exceptions
from loomworks.tools.image import image_guess_size_from_field_name, image_process
from loomworks.tools.mimetypes import MIMETYPE_HEAD_SIZE, get_extension, guess_mimetype
from loomworks.tools.misc import verify_limited_field_access_token
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:loomworks.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~loomworks.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`loomworks.tools.image.image_process`.
