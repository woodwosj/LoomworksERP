...
from loomworks.tools.translate import _, code_translations, LazyTranslate
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str):
        ...
        records matching what :meth:`loomworks.osv.orm.Model.write` expects.

        :param model: :class:`loomworks.osv.orm.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str):
        ...
        :type field: :class:`loomworks.fields.Field`
