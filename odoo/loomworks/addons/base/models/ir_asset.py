...
import loomworks
import loomworks.modules.module  # get_manifest, don't from-import it
from loomworks import api, fields, models, tools
from loomworks.tools import misc
from loomworks.tools.constants import ASSET_EXTENSIONS, EXTERNAL_ASSET
...
class IrAsset(models.Model):
    ...
    def _fill_asset_paths(self, bundle, asset_paths, seen, addons, installed, **assets_params):
        ...
        for addon in addons:
            for command in loomworks.modules.module._get_manifest_cached(addon)['assets'].get(bundle, ()):
    ...
    def _topological_sort(self, addons_tuple):
        ...
        def mapper(addon):
            manif = loomworks.modules.module._get_manifest_cached(addon)
    ...
    def _get_installed_addons_list(self):
        ...
        return self.env.registry._init_modules.union(loomworks.conf.server_wide_modules or [])
    ...
    def _get_paths(self, path_def, installed):
        ...
        addon = path_parts[0]
        addon_manifest = loomworks.modules.module._get_manifest_cached(addon)
