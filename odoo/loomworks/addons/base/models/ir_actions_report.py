...
from loomworks.exceptions import UserError, AccessError, RedirectWarning, ValidationError
from loomworks.service import security
from loomworks.tools.safe_eval import safe_eval, time
from loomworks.tools.misc import find_in_path
from loomworks.tools import check_barcode_encoding, config, is_html_empty, parse_version, split_every
from loomworks.http import request, root
from loomworks.tools.pdf import PdfFileWriter, PdfFileReader, PdfReadError
from loomworks.osv.expression import NEGATIVE_TERM_OPERATORS, FALSE_DOMAIN
...
class IrActionsReport(models.Model):
    ...
    def _handle_merge_pdfs_error(self, error=None, error_stream=None):
        raise UserError(_("Loomworks is unable to merge the generated PDFs."))
    ...
    def _render_qweb_pdf(self, report_ref, res_ids=None, data=None):
        ...
        if error_record_ids:
            ...
            raise RedirectWarning(
                message=_('Loomworks is unable to merge the generated PDFs because of %(num_errors)s corrupted file(s)', num_errors=num_errors),
                action=action,
