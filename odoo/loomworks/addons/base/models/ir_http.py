...
import loomworks
from loomworks import api, http, models, tools, SUPERUSER_ID
from loomworks.exceptions import AccessDenied
from loomworks.http import request, Response, ROUTING_KEYS
from loomworks.modules.registry import Registry
from loomworks.service import security
from loomworks.tools.json import json_default
from loomworks.tools.misc import get_lang, submap
from loomworks.tools.translate import code_translations

_logger = logging.getLogger(__name__)

# see also mimetypes module: https://docs.python.org/3/library/mimetypes.html and loomworks.tools.mimetypes
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (loomworks.exceptions.AccessError, loomworks.exceptions.MissingError) as e:
                ...
                if request.env.user.is_public or isinstance(e, loomworks.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(loomworks.conf.server_wide_modules)
