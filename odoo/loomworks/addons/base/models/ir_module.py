...
from loomworks.exceptions import AccessDenied, UserError, ValidationError
from loomworks.osv import expression
from loomworks.tools import config
from loomworks.tools.parse_version import parse_version
from loomworks.tools.misc import topological_sort, get_flag
from loomworks.tools.translate import TranslationImporter, get_po_paths
from loomworks.http import request
from loomworks.modules import get_module_path
...
class Module(models.Model):
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("Loomworks is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(loomworks.conf.server_wide_modules) & set(self.mapped('name'))
