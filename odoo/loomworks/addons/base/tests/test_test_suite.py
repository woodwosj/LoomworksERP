...
from loomworks.tests.case import TestCase
from loomworks.tests.common import BaseCase, TransactionCase, users, warmup
from loomworks.tests.result import OdooTestResult

_logger = logging.getLogger(__name__)

from loomworks.tests import MetaCase
...
class TestRunnerLoggingCommon(TransactionCase):
    ...
    def _check_log_records(self, log_records):
        ...
        for log_record in log_records:
            ...
            self._assert_log_equal(log_record, 'name', 'loomworks.addons.base.tests.test_test_suite')
