...
from loomworks import modules
from loomworks.exceptions import UserError
from loomworks.tools import config, file_path, mute_logger
...
@patch('loomworks.addons.base.models.ir_mail_server.SMTP_TIMEOUT', SMTP_TIMEOUT)
                    ...
                    with self.subTest(encryption=encryption, certificate=name):
                        ...
                        if error_pattern:
                            ...
                            with self.assertRaises(UserError) as error_capture, \
                                 patch('loomworks.addons.base.models.ir_mail_server.SMTP_TIMEOUT', timeout):
