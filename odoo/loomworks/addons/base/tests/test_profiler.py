...
from loomworks.tests.common import BaseCase, TransactionCase, tagged, new_test_user
from loomworks.tools import profiler
from loomworks.tools.profiler import Profiler, ExecutionContext
from loomworks.tools.speedscope import Speedscope
...
class TestProfiling(TransactionCase):
    ...
    def test_profiler_return(self):
        ...
        self.startClassPatcher(patch('loomworks.sql_db.db_connect', return_value=self.registry))
