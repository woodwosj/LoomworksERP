...
from loomworks.addons.base.models.ir_qweb import QWebException, render
from loomworks.tools import misc, mute_logger
from loomworks.tools.json import scriptsafe as json_scriptsafe
from loomworks.exceptions import UserError, ValidationError, MissingError
...
class TestQWebBasic(TransactionCase):
    ...
    @mute_logger('loomworks.addons.base.models.ir_qweb') # warning for template not found
