...
from loomworks.tools.image import image_to_base64
...
class TestPermissions(TransactionCaseWithUserDemo):
    ...
    def test_read_permission(self):
        ...
        attachment_admin = self.Attachments.with_user(loomworks.SUPERUSER_ID).create({'name': 'foo'})
        ...
        self.assertNotEqual(loomworks.SUPERUSER_ID, admin_user.id)
        attachment_admin.with_user(admin_user).datas

    @mute_logger("loomworks.addons.base.models.ir_rule", "loomworks.models")
