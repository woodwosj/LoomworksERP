...
from loomworks.modules.module import load_manifest
...
class TestModuleManifest(BaseCase):
    ...
    def setUpClass(cls):
        ...
        patcher = patch.object(loomworks.addons, '__path__', [cls.addons_path])
    ...
    def test_default_manifest(self):
        ...
        with self.assertNoLogs('loomworks.modules.module', 'WARNING'):
    ...
    def test_missing_manifest(self):
        with self.assertLogs('loomworks.modules.module', 'DEBUG') as capture:
            manifest = load_manifest(self.module_name)
    ...
    def test_missing_license(self):
        ...
        with self.assertLogs('loomworks.modules.module', 'WARNING') as capture:
            manifest = load_manifest(self.module_name)
