...
from loomworks.addons.base.models.res_users import is_selection_groups, get_selection_groups, name_selection_groups
from loomworks.exceptions import UserError, ValidationError
from loomworks.http import _request_stack
from loomworks.tests import Form, TransactionCase, new_test_user, tagged, HttpCase, users
...
class TestUsers(TransactionCase):
    ...
    @mute_logger('loomworks.sql_db', 'loomworks.addons.base.models.res_users_deletion')
    ...
    def test_context_get_lang(self):
        ...
        request_patch = patch('loomworks.addons.base.models.res_users.request', request)
