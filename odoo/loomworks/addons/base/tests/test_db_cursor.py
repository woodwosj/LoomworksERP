...
from loomworks.sql_db import db_connect, TestCursor
from loomworks.tests import common
from loomworks.tests.common import BaseCase, HttpCase
from loomworks.tools.misc import config
...
class TestTestCursor(common.TransactionCase):
    def setUp(self):
        ...
        self.env = loomworks.api.Environment(self.cr, loomworks.SUPERUSER_ID, {})
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('loomworks.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:loomworks.sql_db:Found different un-closed cursor', msg)
