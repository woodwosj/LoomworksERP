...
@loomworks.tests.tagged('post_install', '-at_install', 'post_install_l10n')
class TestReports(loomworks.tests.TransactionCase):
...
class TestReportsRenderingCommon(loomworks.tests.HttpCase):
    ...
    def save_pdf(self):
        ...
        loomworks.tests.save_test_file(self._testMethodName, self.last_pdf_content, 'pdf_', 'pdf', document_type='Report PDF', logger=_logger)
...
@loomworks.tests.tagged('post_install', '-at_install', 'pdf_rendering')
...
@loomworks.tests.tagged('post_install', '-at_install', '-standard', 'pdf_rendering')
...
class TestAggregatePdfReports(loomworks.tests.HttpCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
