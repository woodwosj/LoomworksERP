...
from loomworks.tests.common import BaseCase, TransactionCase
from loomworks.tools import SQL, mute_logger, sql
...
class TestSqlTools(TransactionCase):
    ...
    def test_add_constraint(self):
        ...
        with self.assertRaises(CheckViolation), mute_logger('loomworks.sql_db'):
