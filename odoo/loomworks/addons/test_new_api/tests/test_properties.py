...
from loomworks.tests import Form, TransactionCase, users
from loomworks.tools import mute_logger, get_lang
...
class PropertiesCase(TestPropertiesMixin):
    ...
    @mute_logger('loomworks.models.unlink', 'loomworks.fields')
    ...
    @users('test')
    @mute_logger('loomworks.addons.base.models.ir_rule', 'loomworks.fields')
    ...
    def test_properties_field_security(self):
        ...
        self.env.invalidate_all()
        with patch('loomworks.addons.test_new_api.models.test_new_api.MultiTag.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        ...
        self.env.invalidate_all()
        with patch('loomworks.addons.test_new_api.models.test_new_api.Discussion.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        self.assertEqual(values['value'], (tag.id, 'Test Tag'))
...
class PropertiesGroupByCase(TestPropertiesMixin):
    ...
    @mute_logger('loomworks.fields', 'loomworks.models.unlink')
