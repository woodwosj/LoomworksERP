...
from loomworks import models, fields, Command
from loomworks.addons.base.tests.common import TransactionCaseWithUserDemo
from loomworks.addons.base.tests.test_expression import TransactionExpressionCase
from loomworks.exceptions import AccessError, MissingError, UserError, ValidationError
from loomworks.tests import TransactionCase, tagged, Form, users
from loomworks.tools import mute_logger, float_repr
from loomworks.tools.date_utils import add, subtract, start_of, end_of
...
%endif"""
    ...
    def test_85_binary_guess_zip(self):
        from loomworks.addons.base.tests.test_mimetypes import ZIP
    ...
    def test_86_text_base64_guess_svg(self):
        from loomworks.addons.base.tests.test_mimetypes import SVG
...
class TestX2many(TransactionExpressionCase):
    ...
    def test_10_ondelete_many2many(self):
        ...
        with self.assertRaises(psycopg2.IntegrityError):
            with mute_logger('loomworks.sql_db'), self.cr.savepoint():
                record_a.unlink()
...
%endif"""
    ...
    @patch('loomworks.fields.html_sanitize', return_value='<p>comment</p>')
...
class TestFieldParametersValidation(TransactionCase):
    def test_invalid_parameter(self):
        ...
        with self.assertLogs('loomworks.fields', level='WARNING') as cm:
            self.registry.setup_models(self.env.cr)

        self.assertTrue(cm.output[0].startswith(
            "WARNING:loomworks.fields:Field test_new_api.field_parameter_validation.name: "
