...
class TestUi(HttpCaseWithUserDemo):
    ...
    def test_01_admin_widget_x2many(self):
        ...
        self.start_tour("/loomworks/action-test_new_api.action_discussions",
            'widget_x2many', login="admin", timeout=120)


@loomworks.tests.tagged('-at_install', 'post_install')
class TestUiTranslation(loomworks.tests.HttpCase):

    @mute_logger('loomworks.sql_db', 'loomworks.http')
    def test_01_sql_constraints(self):
        ...
        self.start_tour("/loomworks/action-test_new_api.action_categories",
