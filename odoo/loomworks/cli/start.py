...
from loomworks.modules.module import get_module_root, MANIFEST_NAMES
from loomworks.service.db import _create_empty_database, DatabaseExists
...
class Start(Command):
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            loomworks.tools.config['init']['base'] = True
