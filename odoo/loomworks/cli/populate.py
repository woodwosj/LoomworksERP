...
from loomworks.tools.populate import populate_models
...
class Populate(Command):
    ...
    def run(self, cmdargs):
        ...
        opt = loomworks.tools.config.parse_config(cmdargs, setup_logging=True)
        ...
        with registry.cursor() as cr:
            env = loomworks.api.Environment(cr, loomworks.SUPERUSER_ID, {'active_test': False})
