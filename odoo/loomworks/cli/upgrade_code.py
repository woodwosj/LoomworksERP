...
try:
    ...
    from loomworks.modules import initialize_sys_path
    from loomworks.tools import config, parse_version
except ImportError:
...
class UpgradeCode(Command):
    ...
    def __init__(self):
        self.parser = argparse.ArgumentParser(
            ...
            description=__doc__.replace('/loomworks/upgrade_code', str(UPGRADE)),
    ...
    def run(self, cmdargs):
        ...
        if initialize_sys_path:
            ...
            initialize_sys_path()
            options.addons_path = loomworks.addons.__path__
        else:
