...
from loomworks.models import check_property_field_value_name, READ_GROUP_NUMBER_GRANULARITY
from loomworks.tools import Query, SQL, get_lang
from loomworks.tools.sql import pattern_to_translated_trigram_pattern, value_to_translated_trigram_pattern
...
def get_unaccent_wrapper(cr):
    ...
    return loomworks.modules.registry.Registry(cr.dbname).unaccent
