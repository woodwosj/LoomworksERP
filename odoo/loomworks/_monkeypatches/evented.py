...
It will initialize the `loomworks.evented` variable.
"""
import loomworks
import sys

loomworks.evented = False


def patch_evented():
    if loomworks.evented or not (len(sys.argv) > 1 and sys.argv[1] == 'gevent'):
        return
