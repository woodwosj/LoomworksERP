...
def get_test_modules(module):
    ...
    results = _get_tests_modules(importlib.util.find_spec(f'loomworks.addons.{module}'))
...
def _get_upgrade_test_modules(module):
    upgrade_modules = (
        f"loomworks.upgrade.{module}",
        f"loomworks.addons.{module}.migrations",
        f"loomworks.addons.{module}.upgrades",
    )
